...
- [x] T002 [P] Verdict helper script and client (B4, B5) — files: rust/crates/worklog-core/templates/verdict_server.py, rust/crates/worklog-core/src/verdict.rs — verify: `python3 rust/crates/worklog-core/templates/verdict_server.py --self-test && cargo test --manifest-path rust/Cargo.toml -p worklog-core verdict::` — after: T001 — done: fbefc11
- [x] T003 [P] Relative filing rule (B1, B2, B3, B4) — files: rust/crates/worklog-core/src/routing.rs, rust/crates/worklog-core/src/routing_test.rs — verify: `cargo test --manifest-path rust/Cargo.toml -p worklog-core routing` — after: T001 — done: a7470c4
- [x] T004 [P] Verdict serve and status commands (B7) — files: rust/crates/worklog-cli/src/cli.rs — verify: `cargo test --manifest-path rust/Cargo.toml -p worklog-cli verdict` — after: T001 — done: 27a12db
- [x] T005 [P] Daemon ratio settings (B6) — files: rust/crates/worklog-core/src/daemon.rs — verify: `cargo test --manifest-path rust/Cargo.toml -p worklog-core daemon::` — after: T001 — done: 1f8013d
- [x] T007 Exact repo or path mention files by rule (FR-10) — files: rust/crates/worklog-core/src/routing.rs, rust/crates/worklog-core/src/routing_test.rs — verify: `cargo test --manifest-path rust/Cargo.toml -p worklog-core routing` — after: T003 — done: 737d516
